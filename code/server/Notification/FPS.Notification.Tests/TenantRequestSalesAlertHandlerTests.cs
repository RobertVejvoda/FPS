...
public sealed class TenantRequestSalesAlertHandlerTests
{
    ...
    private static Mock<IEmailNotificationSender> OkSender(Action<NotificationRecord>? capture = null)
    {
        ...
        sender.Setup(s => s.SendAsync(It.IsAny<NotificationRecord>(), It.IsAny<string>(), It.IsAny<ComposedEmail>(), It.IsAny<CancellationToken>()))
            .Callback<NotificationRecord, string, ComposedEmail, CancellationToken>((r, _, _, _) => capture?.Invoke(r))
    ...
    public async Task Handle_ReplayedEvent_SendsEmailOnce()
    {
        ...
        sender.Verify(s => s.SendAsync(It.IsAny<NotificationRecord>(), It.IsAny<string>(), It.IsAny<ComposedEmail>(), It.IsAny<CancellationToken>()), Times.Once);
    }
