...
public interface IBookingRepository
{
    ...
    Task UpdateBookingRequestStatusAsync(Guid requestId, string status, string? reasonCode = null, string? reason = null, CancellationToken cancellationToken = default);
