...
public interface IBookingRepository
{
    ...
    Task UpdateBookingRequestStatusAsync(Guid requestId, string status, string? reason = null, string? rejectionCode = null, CancellationToken cancellationToken = default);
