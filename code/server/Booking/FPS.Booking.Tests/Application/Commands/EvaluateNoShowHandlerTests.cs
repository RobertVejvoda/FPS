...
public sealed class EvaluateNoShowHandlerTests
{
    ...
    public async Task Handle_NeitherEnabled_NeverUpdatesStatus()
    {
        ...
        repository.Verify(r => r.UpdateBookingRequestStatusAsync(
            It.IsAny<string>(), It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task Handle_EligibleAllocatedRequest_MarksNoShow()
    {
        ...
        repository.Verify(r => r.UpdateBookingRequestStatusAsync(
            It.IsAny<string>(), It.IsAny<Guid>(), "NoShow", It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Once);
    }
