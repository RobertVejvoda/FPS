...
public interface IBookingRepository
{
    ...
    Task UpdateBookingRequestStatusAsync(string tenantId, Guid requestId, string status, string? reason = null, string? rejectionCode = null, string? allocatedSlotId = null, CancellationToken cancellationToken = default);
