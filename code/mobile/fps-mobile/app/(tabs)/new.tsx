...
const styles = StyleSheet.create({
  ...
  outcomeCardOk: { backgroundColor: colors.successSoft, borderColor: colors.successBorder },
  ...
  outcomeTextOk: { color: colors.successText },
  ...
  scheduleBannerOpen: { backgroundColor: colors.successSoft, borderColor: colors.successBorder },
