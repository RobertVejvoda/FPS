...
The mobile application is the employee self-service client for FairSpot. It uses React Native with Expo so the team can build and test the app without native iOS or Android project maintenance in early slices.
