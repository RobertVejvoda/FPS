...
| `Commercialisation Later` | `BILL000`, `BILL001` | Decide how FPS can recover cost without weakening the free/open core. | `BILL000` documents the commercial posture; `BILL001` remains deferred until a real Billing workflow is approved. | Billing and paid features follow product proof, not lead it. |
