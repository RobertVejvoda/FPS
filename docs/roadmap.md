...
| `Client Evaluation` | `ID002`, `P002`, `CFG003`, `CUST001`, `REPORT003`, `WEB001`-`WEB004` | Give business, HR/facilities, architecture, and reporting stakeholders enough product surface to evaluate FPS. | Admin/reporting workflows, web surfaces, user/profile mapping, customer onboarding, fixed operational reports, and configuration publication are credible enough for review. | Client evaluators need more than the employee mobile app; they need operating, reporting, and onboarding evidence. |
