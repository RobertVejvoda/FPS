...
* [Open-Core Boundary](./strategy-layer/open-core-boundary)
...
* [Operations](./production)
  ...
  * Public operations contracts
    ...
    * [Incident Handling Contract](./production/incident-handling)
...
* [Guided Tours](./tours/)
  * [Resource User](./tours/resource-user)
  * [Sponsor & Evaluator](./tours/sponsor-evaluator)
  * [Tenant Admin](./tours/tenant-admin)
  * [HR & Operator](./tours/operator-hr)
  * [Auditor & Security](./tours/auditor-security)
  * [Technical Evaluator](./tours/technical-evaluator)
  * [Green Logistics Walkthrough](./tours/green-logistics-walkthrough)
  * [Tour Decks](./tours/decks/)
    * [Sponsor & Evaluator Deck](./tours/decks/sponsor-evaluator-deck)
    * [Tenant Admin Deck](./tours/decks/tenant-admin-deck)
    * [Resource User Deck](./tours/decks/resource-user-deck)
