...
| `BR012` Scalability and Flexibility | [Business Requirements](./business-layer/requirements), [Production](./production) | `OPS000`, `OPS001`, `OPS002`, `OPS003`, `OPS006`, DataHub slices | Partial | PR #102, #167, #188, #191, DataHub planning docs | Local/demo deployment profiles, operational runbooks, and DataHub direction support growth; production customer hosting, larger tenant evidence, and full read-model resilience remain gaps. |
| `BR013` HR Parking Request Support | [Business Requirements](./business-layer/requirements), [Role Intent Roadmap](./business-layer/role-intent-roadmap), [Booking API Contract](./business-layer/booking-api-contract) | `UX451`, future `HR001` | Partial | Issue #452, PR #454 in review | Parking Requests and Draws are being separated for HR clarity. Remaining gaps include attention queue, safe request lookup, lifecycle explanation, audit links, short display references, and manual correction workflows. |
| `BR014` Parking Map and Capacity Visibility | [Business Requirements](./business-layer/requirements), [Role Intent Roadmap](./business-layer/role-intent-roadmap) | `MAP001`, future `FAC001` | Planned | Issue #455 | Read-only role-safe capacity map is specified. Editable resource-map maintenance, publication workflow, and advanced facility operations remain future slices. |
