...
| `BR008` Reporting and Analytics | [Business Requirements](./business-layer/requirements) | `REPORT001`, `WEB006`, future `REPORT002` | Partial | PR #124, #199 | Tenant-scoped summary/fairness read models, web reporting dashboard, and CSV export exist; custom reports and richer export scheduling remain later. |
