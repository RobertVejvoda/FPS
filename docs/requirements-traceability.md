...
| `BR002` Fair Slot Allocation | [Business Requirements](./business-layer/requirements), [Allocation Rules](./business-layer/allocation-rules) | `B004`, `B005`, `B007`, `B010`, `REPORT001`, `WEB006`, future `REPORT003` | Partial | PR #13, #14, #17, #19, #124, #199 | Core allocation, reporting read-model evidence, and first dashboard views exist; utilization/reason/outcome reporting remains planned. |
...
| `BR008` Reporting and Analytics | [Business Requirements](./business-layer/requirements), [Reporting](./business-layer/reporting) | `REPORT001`, `REPORT002`, `WEB006`, future `REPORT003` | Partial | PR #124, #199 | Tenant-scoped summary/fairness read models, web reporting dashboard, and summary CSV export exist; fixed utilization/reason/outcome reports and export hardening remain. |
...
| `BR010` Auditability and Compliance | [Business Requirements](./business-layer/requirements), [Audit](./business-layer/audit), [Security](./security) | `A001`, `A002`, `A004`, `A005`, `WEB008`, `CFG003` | Partial | PR #37, #39, #112, #198, #199 | Append-only audit records, auditor query, GDPR PII mapping erasure, retention, integrity verification, export evidence, and web audit console exist; configuration-change audit remains. |
| `BR011` Multi-Tenant Customer Model | [Business Requirements](./business-layer/requirements), [Tenant Onboarding](./business-layer/tenant-onboarding), [Versions and Decisions](./versions-and-decisions) | `BK011`, `CFG001`, `OPS001`, `OPS002`, `CUST001`, future `CUST003`-`CUST007` | Partial | PR #27, #33, #42 | Tenant-scoped implementation exists in core paths and onboarding contract is now explicit; tenant workspace lifecycle, identity setup, parking bootstrap, employee/profile bootstrap, and readiness checks remain. |
...
| Demo and client evaluation readiness | [Demo and Evaluation](./demo-and-evaluation), [Client Evaluation Pack](./client-evaluation-pack), [Demo Environment Baseline](./production/demo-environment-baseline) | `DOCS001`, `OPS002`, mobile/web/admin slices | Partial | `OPS002`, `DOCS001` | Demo environment baseline and first client evaluation pack exist; mobile polish, web/admin surfaces, hosted demo evidence, and production handoff remain. |
| Frontend accessibility and usability | [Non-functional Requirements](./technology-layer/non-functional-requirements) | `MOB001`-`MOB009`, `WEB001`-`WEB004` | Partial | PR #48, #51, #55, #76, #78, #87, #95, `MOB007` | Mobile core flow, notifications, and read-only profile/vehicle details exist; mobile draw visibility, polish, and web app remain planned. |
