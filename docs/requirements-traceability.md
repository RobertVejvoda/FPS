...
| Availability and operations | [Production](./technology-layer/production), [Security](./security) | `OPS000`, `OPS001`, `OPS002`, `OPS003` | Planned | Issue #100 | Cloud deployment, observability, backups, and incident runbooks are explicit future slices. |
