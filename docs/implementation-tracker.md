...
| Production operations | In progress | OPS000 strategy document written (PR pending Codex review). Azure Container Apps recommended as first production target. 7 open questions documented for Robert/Codex approval before OPS001 begins. |
...
| OPS000 Hosting And Deployment Strategy Options | In Review | [#100](https://github.com/RobertVejvoda/FPS/issues/100) | PR pending | `initiated-by: codex`, `claude-ready` | Pending Robert/Codex approval | Strategy document written. Recommends Azure Container Apps (Consumption). 7 open questions for approval before OPS001. |
