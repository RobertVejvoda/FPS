...
| BILL000 Commercialisation Impact Review | In progress | [#150](https://github.com/RobertVejvoda/FPS/issues/150) | Current docs PR | Codex/spec | Before Billing implementation | Documents open-core boundaries, paid service candidates, support subscription direction, future dual-license posture, and why Billing remains deferred. |
