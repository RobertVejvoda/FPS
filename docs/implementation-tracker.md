...
| Platform integration foundation | Done | ID001, ID002, BK011, P001, P002, N001-N005, A001-A005, CFG001-CFG003, API001, CI001, REPORT001-REPORT003, OPS000-OPS006, and CUST001-CUST006 are merged; CUST007 is in review. |
...
| Web app | In progress | WEB001, WEB002, and WEB004-WEB008 are merged for employee self-service, HR/admin, reporting, configuration, audit, profile, and notification surfaces. Remaining web work is the broader tenant admin console (`WEB003`). |
...
| CUST007 Tenant Readiness Check | In review | [#205](https://github.com/RobertVejvoda/FPS/issues/205) | [#216](https://github.com/RobertVejvoda/FPS/pull/216) | `implemented-by: claude`; Codex reviewing | Current review | Readiness checks for identity, first admin, policy, slots, profile facts, booking smoke path, notification, audit, and reporting evidence before live use. |
