...
| Mobile foundation | In progress | MOB001 and MOB002 are merged. MOB003 is ready for Claude handoff. |
| Notification v1 completion | Planned | API, unread counts, SSE, email, and preferences remain. |
...
| MOB003 Mobile Real Login | Ready | [#75](https://github.com/RobertVejvoda/FPS/issues/75) | - | `initiated-by: codex`, `claude-ready` | Next | Real OIDC Authorization Code + PKCE login in Expo mobile app. |
| MOB004 Mobile Booking Submission | Planned | - | - | Unassigned | After MOB003 | Employee request submission from mobile. |
...
| N002 Notification API And Stream | Planned | - | - | Unassigned | After mobile/login priority or when notification UX is needed | Notification history API, unread counts, and SSE stream. |
