...
|---|---|---|---|
| MongoDB | `mongo_data` | Booking, Profile, Configuration, Notification, Audit authoritative state | **Yes** |
...
| RabbitMQ | `rabbitmq_data` | Broker persistence (in-flight domain events) | **Yes** |
| Keycloak | `keycloak_data` | Realm/user/identity state | **Yes** |
