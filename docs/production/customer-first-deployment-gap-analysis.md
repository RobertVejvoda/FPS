...
| Demo seed and Draw evidence | `tools/dev-seed.sh` seeds Prague/Headquarters demo data and now runs a Draw with visible outcomes. | Useful for demos; needs hosted smoke evidence and reset runbook. |
