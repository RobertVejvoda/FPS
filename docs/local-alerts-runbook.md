...
2. Confirm Alertmanager is running: `docker compose --project-directory code/infrastructure --env-file code/infrastructure/nas.env -f docker-compose.yaml -f docker-compose.services.images.yml -f docker-compose.dapr.yml -f docker-compose.nas.yml -f docker-compose.services.nas.yml -f docker-compose.no-host-ports.yml ps alertmanager`
