...
| 3 | Information systems migration | Core content migrated. Remaining work is DataHub contract implementation, Customer persistence, Reporting cleanup, and application cooperation/data ownership diagrams. |
| 4 | Technology architecture migration | Core content migrated. Remaining work is hosted evidence, component hardening, backup/restore proof, deployment diagrams, and operational readiness validation. |
