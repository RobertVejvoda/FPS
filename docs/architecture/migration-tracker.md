...
| Information systems architecture | [Information Systems](/architecture/information-systems/) | Partial | [Application Layer](/application-layer), [DataHub](/application-layer/datahub), [Software Architecture](/technology-layer/software-architecture) | Core service boundaries, DataHub/read-model direction, API expectations, and event integration rules have been restated. Still draft because Customer persistence, DataHub implementation, Reporting cleanup, and generated contract evidence remain. |
| Technology architecture | [Technology Architecture](/architecture/technology/) | Partial | [Technology Layer](/technology-layer), [Production](/production), [Dapr-first Standards](/production/dapr-first-production-standards) | Core runtime, deployment profile, Dapr-first, workflow scheduling, and observability direction has been restated. Still draft because hosted smoke evidence, component hardening, persistence, backup/restore, and telemetry retention remain. |
| Security architecture | [Security Architecture](/architecture/security/) | Partial | [Security](/security), [Security Model](/security/security-model), [Cloudflare WAF Profile](/security/cloudflare-waf-profile) | Core identity, tenant isolation, WAF/origin hardening, Dapr security, privacy, audit, and gap content has been restated. Still draft because hosted validation, retention, DataHub privacy shape, Dapr hardening, and trust-boundary diagrams remain. |
...
| 3 | Information systems migration | Core content migrated. Current pass connected DataHub, Customer durable storage, Reporting cleanup, and application cooperation diagram gaps to central Requirements Management. Remaining work is delivery issue traceability and authoritative diagrams. |
| 4 | Technology architecture migration | Core content migrated. Current pass connected hosted demo, Dapr workflow, multi-instance-safe Draw scheduling, WAF, and observability concerns to central Requirements Management. Remaining work is hosted evidence, component hardening, backup/restore proof, deployment diagrams, and operational readiness validation. |
| 5 | Security architecture migration | Core content migrated. Remaining work is hosted validation, retention evidence, DataHub privacy shape, Dapr hardening, and trust-boundary diagrams. |
